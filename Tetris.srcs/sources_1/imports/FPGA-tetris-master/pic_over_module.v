module pic_over_module(
    input clka,
    input [10:0] col_addr_sig,
    input [10:0] row_addr_sig,
    output douta
);
    parameter addr_start = 48, addr_round = 104;
    parameter col_start = 346;
    parameter col_end = col_start + 128;
    parameter row_start = 344;
    parameter row_end = row_start+32;
    reg [11:0] addr;
    wire [7:0] dout;
    always@(*)begin
